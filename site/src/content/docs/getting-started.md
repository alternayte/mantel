...
description: Run it, make an album, send the link.
---
...
- [configuration.md](configuration/) — every value the app reads
- [self-hosting.md](self-hosting/) — running it for real
- [api.md](api/) — the API, which is the same one the web client uses
- [agents.md](agents/) — tokens, `llms.txt`, MCP
