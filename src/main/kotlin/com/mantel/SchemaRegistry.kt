...
import com.mantel.features.agent.ApiTokens
...
import com.mantel.features.auth.NativeSignIns
 ...
 */
val allTables: List<Table> =
    listOf(Accounts, MagicLinks, NativeSignIns, Sessions, Albums, MediaItems, AlbumItems, ShareLinks, AlbumBundles, ApiTokens)
